...
namespace UniversalEmoticonPackBuilderLib.Builders {
    public class QipSmileConfig : SmilePackBuilder
    {
    ...
    public class PidginSmileConfig : SmilePackBuilder
    {
    ...
    public class AdiumSmileConfig : SmilePackBuilder
    {
    ...
    public class MirandaSmileConfig : SmilePackBuilder
    {
    ...
    public class WIMSkin : SmilePackBuilder
    {
    ...
    public class GMailUserjs : SmilePackBuilder
    {
